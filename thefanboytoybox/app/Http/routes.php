...
Route::get('collectible_stores', 'PagesController@collectible_stores');
Route::get('autograph_sellers', 'PagesController@autograph_sellers');
Route::get('live_events', 'PagesController@live_events');
